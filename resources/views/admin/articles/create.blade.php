...
@section('content')
<div class="card">
    <div class="card-header"><h4>Form Tambah Artikel</h4></div>
    <div class="card-body">
        <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label>Karya Terkait (Opsional)</label>
                ...
                <div class="col-md-12 mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="is_published" value="1" id="published" {{ old('is_published', 1) ? 'checked' : '' }}>
