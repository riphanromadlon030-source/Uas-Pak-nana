@extends('layouts.app')
@section('page-title', 'Edit Lelang')
@section('content')
<div class="card">
    <div class="card-header"><h4>Form Edit Lelang</h4></div>
    <div class="card-body">
        <form action="{{ route('admin.auctions.update', $auction) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <select name="artwork_id" class="form-select @error('artwork_id') is-invalid @enderror" required>
                        @foreach($artworks as $artwork)
                            <option value="{{ $artwork->id }}" {{ old('artwork_id', $auction->artwork_id) == $artwork->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="datetime-local" name="start_date" class="form-control @error('start_date') is-invalid @enderror" 
                           value="{{ old('start_date', $auction->start_date->format('Y-m-d\TH:i')) }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="starting_bid" class="form-control @error('starting_bid') is-invalid @enderror" 
                           value="{{ old('starting_bid', $auction->starting_bid) }}" min="0" required>
            ...
            <div class="d-flex justify-content-between mt-3 pt-3 border-top">
                ...
                <button type="submit" class="btn btn-primary">Update Lelang</button>
            </div>
        </form>
    </div>
</div>
